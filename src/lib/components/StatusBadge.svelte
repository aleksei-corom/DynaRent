<script lang="ts">
	...
	let { estado, capitalize = true }: Props = $props();
...
<span
	class="inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-[11px] font-semibold whitespace-nowrap {classes}"
>
