# Instalación de Dinamo Rent ERP — v1.0.3 (estable)

> Guía para el equipo de operaciones. **Última versión estable: v1.0.3** — añade el
> **auto-update**: a partir de ella la app detecta y ofrece instalar las versiones nuevas
> al arrancar (ver seccion 6), sobre las features de la v1.0.2 (IVA por renta, auto-cálculo
> de días/horas al cerrar, cambio de vehículo, combos con búsqueda). Construida y validada
...
Página de la release: <https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/tag/v1.0.3>

| Instalador | Enlace directo | Tamaño | Uso |
|---|---|---|---|
| **NSIS** (`DinamoRent_1.0.3_x64-setup.exe`) | <https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.3/DinamoRent_1.0.3_x64-setup.exe> | ~21 MB | **Recomendado** — instalación asistida con atajo de escritorio |
| **MSI** (`DinamoRent_1.0.3_x64_en-US.msi`) | <https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.3/DinamoRent_1.0.3_x64_en-US.msi> | ~31 MB | Despliegue empresarial / GPO |

> ⚠️ **No usar la v1.0.0** (descontinuada): falla en equipos sin BD previa. Si un equipo
> ya la tiene instalada **con datos**, no hay que desinstalar — la v1.0.3 abre la BD
...
1. Ejecutar `DinamoRent_1.0.3_x64-setup.exe` como usuario normal.
...
DinamoRent_1.0.3_x64-setup.exe /S
```

### Opción C — Silenciosa (MSI, para GPO/Intune)
```powershell
msiexec /i DinamoRent_1.0.3_x64_en-US.msi /qn /norestart
```
...
- **Actualizar desde v1.0.0**: instalar la v1.0.3 encima. Idempotente, sin pérdida de datos.
