# Instalación de Dinamo Rent ERP — v1.0.13 (estable)
...
|---|---|---|---|
| **NSIS** (`DinamoRent_1.0.13_x64-setup.exe`) | <https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.13/DinamoRent_1.0.13_x64-setup.exe> | ~21 MB | **Recomendado** — instalación asistida con atajo de escritorio |
| **MSI** (`DinamoRent_1.0.13_x64_en-US.msi`) | <https://github.com/CORJAR-Computers/dinamo_rent_tr/releases/download/v1.0.13/DinamoRent_1.0.13_x64_en-US.msi> | ~33 MB | Despliegue empresarial / GPO |
...
1. Ejecutar `DinamoRent_1.0.13_x64-setup.exe` como usuario normal.
...
DinamoRent_1.0.13_x64-setup.exe /S
```

### Opción C — Silenciosa (MSI, para GPO/Intune)
```powershell
msiexec /i DinamoRent_1.0.13_x64_en-US.msi /qn /norestart
```
