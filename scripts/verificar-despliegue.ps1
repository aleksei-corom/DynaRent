# verificar-despliegue.ps1 - Verificacion post-instalacion de DinamoRent v1.0.2
#
...
#
# Comprueba: exe instalado (v1.0.2), %APPDATA%\com.corjar.dinamorent (config.ini
...
if ($exe) {
    ...
    Check "Version 1.0.2" ($ver -like '1.0.2*') "ProductVersion=$ver"
} else {
