# verificar-despliegue.ps1 - Verificacion post-instalacion de DinamoRent v1.0.5
#
...
#
# Comprueba: exe instalado (v1.0.5), %APPDATA%\com.corjar.dinamorent (config.ini
...
if ($exe) {
    ...
    Check "Version 1.0.5" ($ver -like '1.0.5*') "ProductVersion=$ver"
} else {
