# verificar-despliegue.ps1 - Verificacion post-instalacion de DinamoRent v1.0.1
#
...
#
# Comprueba: exe instalado (v1.0.1), %APPDATA%\com.corjar.dinamorent (config.ini
...
if ($exe) {
    ...
    Check "Version 1.0.1" ($ver -like '1.0.1*') "ProductVersion=$ver"
} else {
