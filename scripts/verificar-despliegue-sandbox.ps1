# verificar-despliegue-sandbox.ps1 - Instala la v1.0.16 dentro de Windows
...
$installer = 'C:\shared\bundle\nsis\DynaRent_1.0.16_x64-setup.exe'
...
# 1) Instalacion silenciosa de la v1.0.16
Write-Log "Instalando la v1.0.16 (NSIS /S)..."
