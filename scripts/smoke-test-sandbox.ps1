...
# verifica que la app crea %APPDATA%\com.corjar.dynarent\ con config.ini +
...
# mapeada en el .wsb a D:\dynarent\scripts\) para leerlo tras cerrar
# el Sandbox.
...
$data = "$env:APPDATA\com.corjar.dynarent"
