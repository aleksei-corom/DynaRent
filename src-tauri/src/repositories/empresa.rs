...
pub struct EmpresaConfig {
    ...
    /// País donde se usa la aplicación (para el código telefónico de contacto).
...
pub const SELECT_COLS: &str = "NOMBRE, NIT, DIRECCION, TELEFONO, EMAIL, WEB, CIUDAD, PAIS, LOGO";
